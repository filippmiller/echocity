          ...
          <>
            {totalResults === 0 ? (
              ...
              <div className="space-y-6">
                <p className="text-xs text-gray-400">{totalResults} результатов</p>
                    ...
                    <div className="space-y-2.5">
                      {offers.map((offer) => (
                        <Link
                          ...
                          className="flex items-start gap-3 bg-white border border-gray-100 rounded-xl p-4 hover:border-brand-200 hover:bg-brand-50/30 active:bg-gray-50 transition-colors"
                        >
                          {/* Benefit badge */}
                          <div className="shrink-0 mt-0.5 px-2.5 py-1.5 bg-deal-discount text-white text-sm font-bold rounded-lg min-w-[52px] text-center">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {offer.subtitle && (
                              <p className="text-xs text-gray-500 mt-0.5 truncate">{offer.subtitle}</p>
                            )}
                            {offer.branchTitle && (
