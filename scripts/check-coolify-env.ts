...
const CRITICAL_KEYS: CriticalKey[] = [
  ...
  { key: 'MINIO_ENDPOINT', required: true },
  { key: 'MINIO_ACCESS_KEY', required: true },
  { key: 'MINIO_SECRET_KEY', required: true },
  { key: 'MINIO_BUCKET', required: true },
  { key: 'MINIO_PUBLIC_BASE_URL', required: true },
  { key: 'YANDEX_CLIENT_ID', required: true },
  { key: 'YANDEX_CLIENT_SECRET', required: true },
  { key: 'YANDEX_OAUTH_REDIRECT_URI', required: true },
  { key: 'YANDEX_MAPS_API_KEY', required: true },
  { key: 'NEXT_PUBLIC_YANDEX_MAPS_API_KEY', required: true },
  { key: 'YOKASSA_SHOP_ID', required: true },
  { key: 'YOKASSA_SECRET_KEY', required: true },
  { key: 'YOKASSA_WEBHOOK_SECRET', required: true },
  { key: 'VK_CLIENT_SECRET', required: true },
  { key: 'MAX_CLIENT_SECRET', required: true },
